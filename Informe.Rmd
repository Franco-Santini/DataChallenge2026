...
Se puede observar que la planta de Curitiba es la que mayores costos tiene, siendo estos el 35,8% del costo total. Sin embargo, al ver la relación costo/volumen, todas las plantas tienen un valor parecido, siendo la de Santiago la más eficiente y la de Monterrey la menos. La reducción de los valores de esta relación, será uno de los puntos más importantes en la posterior optimización.
