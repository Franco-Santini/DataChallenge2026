...
- **Headspace máximo:** el espacio libre entre el producto y las paredes de la caja no tiene un mínimo exigido, pero sí un máximo permitido según el grosor del cartón: 6% para cajas de hasta 3,0 mm, 8% para cajas de hasta 4,5 mm y 10% para cajas de más de 5 mm, con un límite absoluto de 40 mm por eje.
...
Además de conservar las dimensiones de las cajas actuales como alternativas de referencia, se generó para cada producto una caja candidata orientada a maximizar el aprovechamiento del pallet. Un patrón de pallet $(n_L,n_W,n_H)$ indica la cantidad de cajas ubicadas sobre cada uno de sus ejes. Por ejemplo, un patrón $(2,4,6)$ representa dos cajas sobre los 800 mm de largo, cuatro sobre los 1200 mm de ancho y seis capas sobre los 1800 mm de altura, alcanzando una capacidad total de 48 cajas por pallet.

Para cada producto se determinó primero el intervalo de dimensiones internas admisibles. A partir de su límite inferior, se enumeraron los patrones de apilado potencialmente alcanzables y se verificó, para cada uno, que existiera una caja que cumpliera simultáneamente las restricciones de dimensiones, volumen y resistencia. Entre las alternativas factibles se seleccionó aquella que permitía transportar la mayor cantidad de cajas por pallet.

Cuando dos alternativas presentaban la misma capacidad, se conservó la de menor volumen interno. De este modo, el procedimiento prioriza la eficiencia logística sin generar cajas innecesariamente sobredimensionadas.
...
Se cuenta con **90.951** = $\binom{427}{2}$ pares posibles de cajas. Aunque no todos los pares de productos podrían tener una caja compatible entre si. Basicamente, dos productos tienen potencial para compartir una caja si sus intervalos admisibles se superponen en los tres ejes y, además, la intersección debe permitir el volumen del producto más voluminoso.

A partir de este cruce, se encontraron **30.291** pares geométricamente compatibles. Para cada uno se construye una caja candidata.
...
<img src="img/greedy_busqueda_local.gif" width="400"/>

</p>

<!-- En segundo lugar, se generaron cajas comunes para pares de productos geométricamente compatibles. Para que dos productos pudieran compartir una caja, sus intervalos admisibles debían superponerse en los tres ejes y la intersección debía permitir contener el mayor de sus volúmenes originales. De los (90.951) pares posibles entre los 427 productos, (30.291) cumplieron estas condiciones preliminares. Para cada uno de ellos se construyó una caja común con el mayor aprovechamiento posible del pallet. -->

<!-- La generación a partir de pares no implica que esos dos productos deban utilizar necesariamente la caja diseñada. Cada candidata fue posteriormente evaluada contra los 427 SKU; por lo tanto, el modelo pudo asignarla a cualquier producto que cumpliera todas las restricciones. Esta estrategia permitió incorporar alternativas de consolidación sin imponer grupos de productos de manera previa. -->
...
Al rediseñar las cajas dentro del margen permitido para optimizar el aprovechamiento volumétrico del pallet, la cantidad promedio de cajas por pallet sube de **59** a **65,7**. Eso representa **119.743** pallets menos por año saliendo de las cinco plantas, con el mismo volumen de producto, pasando de **1.193.792** a **1.074.049** pallets anuales, es decir una reducción del **10%**. 
